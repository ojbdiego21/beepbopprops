...
function seededProps() {
  ...
  const raw = [
    ...
    { n:'Donovan Mitchell',          t:'CLE', opp:'UTA', pos:'SG', st:'rebounds', l:4.5,  dir:'over',  dk:4.5,  dko:'-112', pp:4.5,  fd:4.5,  fdo:'-115', mgm:4.5,  mgmo:'-110', czr:5,    czro:'-122', reb:4.5,  rebo:'-110', conf:65, hr:'6/10', pid:'1628378', reason:'Mitchell pulls 4.6 RPG. UTA depleted interior = extra boards.' },
    ...
    { n:'Ayo Dosunmu',               t:'CHI', opp:'SAS', pos:'PG', st:'assists',  l:4.5,  dir:'over',  dk:4.5,  dko:'-104', pp:4.5,  fd:4.5,  fdo:'-105', mgm:4.5,  mgmo:'-105', czr:4.5,  czro:'-104', reb:4.5,  rebo:'-104', conf:63, hr:'5/10', pid:'1630245', reason:'Dosunmu initiates CHI offense. Low juice -104 = sharp value.' },
    ...
    { n:'Darius Garland',            t:'CLE', opp:'UTA', pos:'PG', st:'assists',  l:6.5,  dir:'over',  dk:6.5,  dko:'-115', pp:6.5,  fd:6.5,  fdo:'-115', mgm:6.5,  mgmo:'-112', czr:7,    czro:'-125', reb:6.5,  rebo:'-112', conf:67, hr:'6/10', pid:'1629636', reason:'Garland 7.2 APG. UTA gives up assists to opposing PGs freely.' },
    ...
    { n:'Trae Young',                t:'ATL', opp:'BOS', pos:'PG', st:'assists',  l:9.5,  dir:'over',  dk:9.5,  dko:'-115', pp:9.5,  fd:9.5,  fdo:'-115', mgm:9.5,  mgmo:'-112', czr:10,   czro:'-128', reb:9.5,  rebo:'-112', conf:68, hr:'6/10', pid:'1629027', reason:'Trae 10.8 APG. ATL home game — high usage expected vs BOS.' },
